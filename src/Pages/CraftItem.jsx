          ...
          <section className="bg-gray-100 text-gray-800">
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
              <a
                ...
                href="#"
                className="block rounded-lg max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-[#a2c4fa]"
              >
                <img
                  src="https://source.unsplash.com/random/480x360"
                  alt=""
                  className="object-cover w-full h-64 rounded-lg sm:h-96 lg:col-span-7 bg-gray-500"
                />
                <div className="p-6 space-y-2 lg:col-span-5">
                  <h3 className="text-2xl font-semibold sm:text-4xl group-hover:underline group-focus:underline">
                    Noster tincidunt reprimique ad pro
                  </h3>
                  <p>Number of data: {paintCrafts.length}</p>
              ...
              <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  <img
                    role="presentation"
                    className="object-cover w-full rounded-t-lg h-44 bg-gray-500"
                    src="https://source.unsplash.com/random/480x360?1"
                  />
                  <div className="p-6 space-y-2 bg-[#a2c4fa]">
