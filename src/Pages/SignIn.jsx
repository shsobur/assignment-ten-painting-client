            ...
            <form onSubmit={handelSignin}>
              ...
              <div className="signin_inputs">
                ...
                <div className="signin_socialmedia_conraienr">
                  <ul>
                    <li><button><FaGoogle /></button></li>
                    <li><button><BsGithub /></button></li>
                  </ul>
                </div>

                <div className="text-center mt-2">
                  <p>Dont have an account yet? <Link to="/signup"><span className="text-blue-800 font-semibold">SignUp</span></Link></p>
                </div>
              </form>
